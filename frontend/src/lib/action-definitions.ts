...
export const ACTION_DEFINITIONS: ActionDefinition[] = [
  {
    ...
    effect: "Dispatches a webhook to open a new long position. Your connected platform handles the order with your configured risk settings.",
    isEntry: true,
  },
  {
    key: "start_short_market_deal",
    label: "Entry Short",
    description: "Dispatch a short/sell entry webhook",
    ...
    effect: "Dispatches a webhook to open a new short position. Your connected platform handles the order with your configured risk settings.",
    isEntry: true,
  },
  {
    key: "start_long_limit_deal",
    label: "Entry Long (Limit)",
    description: "Dispatch a buy limit order webhook",
    ...
    effect: "Dispatches a webhook for a pending buy limit order. Your connected platform places the order at the specified price.",
    isEntry: true,
  },
  {
    key: "start_short_limit_deal",
    label: "Entry Short (Limit)",
    description: "Dispatch a sell limit order webhook",
    ...
    effect: "Dispatches a webhook for a pending sell limit order. Your connected platform places the order at the specified price.",
    isEntry: true,
  },
  {
